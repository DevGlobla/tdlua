...
function function_core.run_table(input)
  ...
  luatele_function.vardump(result)
...
function luatele.VERSION()
  print(luatele_function.colors('%{green}\27[5m'..luatele.logo..'\n'..luatele_function.base64_decode('VGhlIGZpbGVzIHdlcmUgd3JpdHRlbiBhbmQgZGV2ZWxvcGVkIGJ5IHRoZSBkZXZlbG9wZXIgOiBAWVlCWVkgLCBAR0xPQkxB=')))
  return true
end
